        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $check_username = "select* from tbl_admin_login where Username = '$username'";
                    ...
                    if ($check == 0)
                    {
                        $create = "insert into tbl_admin_login (Firstname, Middlename, Lastname, Username, Password, sec_question, answer) values ('$firstname', '$middlename', '$surname', '$username', '$password', '$sec_question', '$answer')";
                        ...
                        if ($query)
                        {
                            echo "<script>
                                ...
                                location.href = 'admin_user_list.php';
                            </script>";
                        }
                    }
...
<div class="container-fluid p-0" style="margin-top: 0.1%;" id="intro">    
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7 mt-5" id="intro2">
            <center>
            <h2><b>Create Account Admin</b></h2>
            </center>
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password_1" type="password" class="form-control" name="password" required autocomplete="current-password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="button" data-toggle="modal" data-target="#confirmModal_create" data-dismiss="modal" class="btn form-control" style="background-color: black; color: white;">  
                                CREATE
                                </button>
                            </div>
                        </div>

                        <div class="modal fade" id="confirmModal_create" role="dialog">
