<?php
    ...
    else
    {
        if (isset($_GET['id']))
        {
            ...
            $check_id = "select* from tbl_admin_login where id_no = '$id'";
            ...
            if (isset($_POST['update']))
            {
                ...
                {
                    $update = "update tbl_admin_login set Firstname = '$firstname', Middlename = '$middlename', Lastname = '$surname', Password = '$password' where id_no = '$id'";
        ...
        $select_account = "select* from tbl_admin_login where id_no = '$_GET[id]'";
