...
<div id="main" class="container-fluid mt-5">
	...
	<div class="mt-5">
    	<h5 class="text-center">MENU LIST<br><br>CATEGORY CUSTOM</h5>
  	</div>
    <div class="container-fluid mt-5">
        <div class="row">
            <?php
                ...
                $select_product = "select* from tbl_item where Category = 'Custom'";
                                    ...
                                    <div style="width: 50%;">
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        <input type="button" value="(+)" id="clickclick<?php echo $in; ?>" class="btn ml-3" style="background-color: #3D3324;; color: white;">
                                                        <input type="number" <?php if($get_table['status'] == "For Payment" || $get_table['status'] == "Order Processing" || $get_table['status'] == "Order Served"){ ?> readonly <?php } ?> name="qty_large" id="countingcounting<?php echo in; ?>" class="form-control numbers-only ml-1" style="width: 40%;" value="<?php echo $get_qty1; ?>">
                                                        <input type="button" value="(-)" id="clickbyclickby<?php echo $in; ?>" class="btn ml-1" style="background-color: #3D3324;; color: white;">
                                                    </div>
