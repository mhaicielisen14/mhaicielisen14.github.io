<?php
    ...
    else
    {
        ...
        if (isset($_POST['update']))
        {
            ...
            {
                $update = "update tbl_kitchen_login set Firstname = '$firstname', Middlename = '$middlename', Surname = '$surname', Password = '$password' where Username = '$username'";
                $query1 = @mysqli_query($connection2, $update);

                if ($query1)
                {
                    echo "<script>
                        alert('Successfully updated kitchen user');
                    </script>";
                }
            }
        }

        require './headers_footers/kitchen_header.php';

        $select_account = "select* from tbl_kitchen_login where Username = '$username'";
                        ...
                        <div class="card-body" style="background-color: black;">
                            <form method="POST" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="surname" type="text" value="<?php echo $get_account['Surname']; ?>" class="form-control" name="surname" required autocomplete="surname" autofocus>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    Are you sure you want to update this Kitchen user?
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <input type="submit" class="btn border border-dark" style="background-color: white; color: black;" name="update" value="YES">
