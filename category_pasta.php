...
<div id="main" class="container-fluid mt-5">
	...
	<div class="mt-5">
    	<h5 class="text-center">MENU LIST<br><br>CATEGORY PASTA</h5>
  	</div>
    <div class="container-fluid mt-5">
        <div class="row">
            <?php
                ...
                $select_product = "select* from tbl_item where Category = 'Pasta'";
                                ...
                                <div class="d-flex">                            
                                        ...
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        ...
                                                        <input type="button" id="clickby<?php echo $in; ?>" value="(-)" class="btn ml-1" style="background-color: #3D3324;; color: white;">
                                                    </div>
                                    ...
                                    <div style="width: 50%;">
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        <input type="button" value="(+)" class="btn ml-3" id="clickclick<?php echo $in; ?>" style="background-color: #3D3324;; color: white;">
