<?php
    ...
    if (isset($_POST['verify']))
    {
        ...
        $search_username = "select* from tbl_admin_login where Username = '$username'";
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        $update_pass = "update tbl_admin_login set Password = '$_POST[password99]' where Username = '$username'";
    ...
    if (isset($_POST['login']))
    {
        ...
        $select = "select* from tbl_admin_login";
...
<div class="container-fluid p-0" style="margin-top: 0.1%;" id="intro">
    <div class="d-flex">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item ml-3 mr-3"> <a class="nav-link" href="kitchen_login.php" style="color: black; text-shadow: 1px 1px white; font-size: 20px;"><u>Kitchen Log In</u></a></li>
        </ul>
    </div>
