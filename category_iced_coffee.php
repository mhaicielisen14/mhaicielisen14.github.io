...
<div id="main" class="container-fluid mt-5">
	...
	<div class="mt-5">
    	<h5 class="text-center">MENU LIST<br><br>CATEGORY ICED COFFEE</h5>
  	</div>
    <div class="container-fluid mt-5">
        <div class="row">
            <?php
                ...
                $select_product = "select* from tbl_item where Category = 'Iced Coffee'";
                                ...
                                <div class="d-flex">                            
                                        ...
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        <input type="button" id="click<?php echo $in; ?>" value="(+)" class="btn ml-3" style="background-color: #3D3324;; color: white;">
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        ...
                                                        <input type="button" value="(-)" class="btn ml-1" id="clickby<?php echo $in; ?>" style="background-color: #3D3324;; color: white;">
                                                    </div>
                                    ...
                                    <div style="width: 50%;">
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        <input type="button" id="clickclick<?php echo $in; ?>" value="(+)" class="btn ml-3" style="background-color: #3D3324;; color: white;">
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        <input type="button" id="clickclick<?php echo $in; ?>" value="(+)" class="btn ml-3" style="background-color: #3D3324;; color: white;">
                                                        <input type="number" id="countingcounting<?php echo $in; ?>" <?php if($get_table['status'] == "For Payment" || $get_table['status'] == "Order Processing" || $get_table['status'] == "Order Served"){ ?> readonly <?php } ?> name="qty_large" class="form-control numbers-only ml-1" style="width: 40%;" value="<?php echo $get_qty1; ?>">
                                                        <input type="button" value="(-)" class="btn ml-1" id="clickbyclickby<?php echo $in; ?>" style="background-color: #3D3324;; color: white;">
                                                    </div>
