<?php
    ...
    else
    {
        if (isset($_GET['id']))
        {
            ...
            $check_id = "select* from tbl_kitchen_login where id_no = '$id'";
            $query2 = @mysqli_query($connection2, $check_id);
            ...
            if ($count == 0)
            {
                header("Location: kitchen_user_list.php");
            }
            ...
            if (isset($_POST['update']))
            {
                ...
                {
                    $update = "update tbl_kitchen_login set Firstname = '$firstname', Middlename = '$middlename', Surname = '$surname', Password = '$password' where id_no = '$id'";
        ...
        $select_account = "select* from tbl_kitchen_login where id_no = '$_GET[id]'";
