...
<div id="main" class="container-fluid mt-5">
	...
	<div class="mt-5">
    	<h5 class="text-center">MENU LIST<br><br>CATEGORY COFFEE</h5>
  	</div>
    <div class="container-fluid mt-5">
        <div class="row">
            <?php
                ...
                $select_product = "select* from tbl_item where Category = 'Coffee'";
                                        ...
                                        <center>
                                            ...
                                            ?>
                                                    <div class="d-flex p-1">
                                                        ...
                                                        <input type="button" id="clickbyclickby<?php echo $in; ?>" value="(-)" class="btn ml-1" style="background-color: #3D3324;; color: white;">
                                                    </div>
