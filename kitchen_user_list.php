<?php
    ...
    if (isset($_POST['delete']))
    {
        ...
        $delete = "delete from tbl_kitchen_login where id_no = '$id'";
        $query = @mysqli_query($connection2, $delete);

        if ($query)
        {
            echo "<script>
                    alert('Successfully Deleted Kitchen User');
                    window.location.href = 'kitchen_user_list.php';
            </script>";
        }
    }
...
?>
        ...
        <div class="mt-4">
            ...
            <center>
                <h3 class="mt-5"><b>KITCHEN USER LIST</b></h3>
                ...
                <div class="mt-5 mb-5">
                    <table class="admin-menu-table">
                        ...
                        <tbody>
                            <?php
                                $selectitem = "select* from tbl_kitchen_login";
                            ...
                            ?>
                                    <tr style="color: black; font-size: 1.8vw;">
                                        ...
                                        <td style="border: 1px solid black;" class="p-2 text-center"><?php echo $get['Surname']; ?></td>
                                        <td style="border: 1px solid black;" class="p-2 text-center"><?php echo $get['Username']; ?></td>
                                        <td style="border: 1px solid black;" class="p-1 text-center"><form action="edit_profile2.php?id=<?php echo $get['id_no']; ?>" method="post"><input type="submit" class="btn btn-sm border border-dark" style="font-size: 1.5vw; background-color: white; color: black;" value="EDIT"></form></td>
            ...
            <form action="" method="post">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: black;">
                        ...
                        <h4 class="modal-title ml-2" style="Color: white;">Delete Kitchen User</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                Are you sure you want to delete Kitchen User Id No <p id="categoryID1"></p>
